...
export const ConsultationSection = () => {
  return (
      <section id={"gameConsultation"} className={"relative"}>
        <section className={"py-[100px] flex justify-center items-center bg-[rgb(20,22,23)]"}>
          <section className={"flex justify-center items-center w-full min-w-[328px] max-w-[820px]"}>
            <div className={"flex flex-col items-center"}>
              <h2 className={"relative font-[600] text-[20px] leading-[26px] text-white whitespace-pre-wrap text-center mb-[20px]"}>맞춤형으로 학습을 시작하고 싶다면?</h2>
