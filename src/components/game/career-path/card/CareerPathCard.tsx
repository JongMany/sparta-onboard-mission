      ...
      <div
        ...
        <div className={"mt-[24px] text-[13px] leading-[20px] flex flex-col gap-[8px]"}>
          {jobWorks.map((work) => <div
            ...
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.66565 8L5.99898 11.3333L13.3323 4" stroke="#FF6C7A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>
