...
const SubNavbar = () => {
  ...
  return (
      <>
        ...
        <div
            className={`sticky border-b-[1px] border-b-[rgba(214, 224, 230)] bg-white overflow-x-scroll scrollbar-hide z-20 pt-[10px] flex items-center lg:items-start tablet:justify-center lg:justify-center gap-[2px] lg:gap-[20px] tablet:px-[10px] py-[0px] ${direction === "up" ? "top-[60px]" : "top-0"}`}>
          <div className={"flex flex-col justify-center items-center gap-[10px]"}>
            <button
                onClick={() => scrollToSection('gameProject')}
                className={"whitespace-nowrap flex py-[6px] px-[10px] justify-center items-center gap-[10px] font-[400] text-[16px] leading-[26px] text-[rgb(157,167,174)] transition duration-300 ease-in-out rounded-[10px] relative hover:bg-[rgb(242,246,248)] hover:text-[rgb(58,62,65)]"}>프로젝트
            </button>
            <div
          ...
          <div className={"flex flex-col justify-center items-center gap-[10px]"}>
            <button
                ...
                className={"whitespace-nowrap flex py-[6px] px-[10px] justify-center items-center gap-[10px] font-[400] text-[16px] leading-[26px] text-[rgb(157,167,174)] transition duration-300 ease-in-out rounded-[10px] relative hover:bg-[rgb(242,246,248)] hover:text-[rgb(58,62,65)]"}>커리큘럼
            </button>
            <div
                className={"w-full h-[2px] bg-[rgb(255,108,122)] opacity-0 transition-opacity duration-300 ease-in-out"}></div>
          </div>
